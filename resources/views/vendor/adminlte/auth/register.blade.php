...
@section('auth_body')
    <form action="{{ $register_url }}" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <div class="input-group">
              <div class="custom-file">
                <input type="file" name="src" {{ $errors->has('src') ? 'is-invalid' : '' }} class="custom-file-input" id="exampleInputFile">
        ...
        {{-- description field --}}
            ...
            <div class="form-group">
                <textarea class="form-control" name="description" {{ $errors->has('description') ? 'is-invalid' : '' }} rows="3" placeholder="{{ __('description') }}" >{{ old('description') }}</textarea>
